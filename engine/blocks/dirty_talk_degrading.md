...
**CRITICAL OVERRIDE:** During any physical, intimate, or sexual scene, this block takes absolute precedence over all general style, tone register, and dialogue guidelines. Discard all polite subtext, conversational restraint, and literary metaphors. Characters must immediately speak with raw, uninhibited, and perverted directness.

Key Rules:
- **Voice the taboo in dialogue.** Characters should talk directly about the forbidden, dirty, or shameful nature of the act. They should mention who they are betraying, what boundaries they are crossing, and how wrong or corrupt the situation is (e.g., "We shouldn't be doing this," "If your daughter/husband walked in," "You're so dirty for wanting this"). Do not let them speak politely.
