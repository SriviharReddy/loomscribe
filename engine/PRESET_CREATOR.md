...
- Modify only `id`, `title`, `category`, `description`, `system_body`, `post_history_body`, and optionally preset defaults such as `pov`, `erotic_intensity`, `dirty_talk`, `pov_focus`, `pushback`, `outline_mode`, or `premises_mode`.
