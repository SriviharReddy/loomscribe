...
export function initPresetManager() {
    ...
    const watchedIds = [
        ...
        'pm-field-post-history', 'pm-default-pov', 'pm-default-erotic',
...
function populateForm(preset) {
    ...
    el('pm-default-erotic').value       = d.erotic_intensity || 'explicit';
    el('pm-default-dirty-talk').value   = d.dirty_talk || 'teasing';
...
function resetEditor() {
    ...
    el('pm-default-erotic').value = 'explicit';
...
function collectFormData() {
    return {
        ...
        defaults: {
            ...
            erotic_intensity: el('pm-default-erotic').value,
            dirty_talk: el('pm-default-dirty-talk').value,
